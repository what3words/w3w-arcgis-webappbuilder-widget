        ...
        switch (part.operator) {
          case this.OPERATORS.dateOperatorIsOn:
            if (part.valueObj.type === 'field') {
              ...
              whereClause = "(" + part.fieldObj.name + " BETWEEN " + (!supportsStandardizedQuery? "" : "timestamp ") +
                "'" + this.formatDate(value) + "' AND " + (!supportsStandardizedQuery? "" : "timestamp ") +
                "'" + endDateTime + "') AND " +
          ...
          case this.OPERATORS.dateOperatorIsNotOn:
            if (part.valueObj.type === 'field') {
              ...
              whereClause = "(" + part.fieldObj.name + " < " +
                (!supportsStandardizedQuery? "" : "timestamp ") + "'" + this.formatDate(value) + "') OR " +
                "(" + part.fieldObj.name + " >= " + (!supportsStandardizedQuery? "" : "timestamp ") + "'" + endDateTime + "')";
            }
            break;
          case this.OPERATORS.dateOperatorIsBefore:
            if (part.valueObj.type === 'field') {
              ...
              whereClause = part.fieldObj.name + " < " +
               (!supportsStandardizedQuery? "" : "timestamp ") + "'" + this.formatDate(value) + "'";
            }
            break;
          ...
          case this.OPERATORS.dateOperatorIsIn:
            ...
            whereClause = "(" + part.fieldObj.name + " BETWEEN " + (!supportsStandardizedQuery? "" : "timestamp ") +
              "'" + this.formatDate(value1) + "' AND " + (!supportsStandardizedQuery? "" : "timestamp ") +
              "'" + endDateTime + "') AND " +
              "(" + part.fieldObj.name + " <> " + (!supportsStandardizedQuery? "" : "timestamp ") + "'" + endDateTime + "')";
            break;
          ...
          case this.OPERATORS.dateOperatorIsNotIn:
            endDateTime = this._getEndDateByTime(value2, part.valueObj.enableTime2, part.valueObj.timeAccuracy2);
            whereClause = "(" + part.fieldObj.name + " < " +
              (!supportsStandardizedQuery? "" : "timestamp ") + "'" + this.formatDate(value1) + "') OR " +
              "(" + part.fieldObj.name + " >= " + (!supportsStandardizedQuery? "" : "timestamp ") + "'" + endDateTime + "')";
            break;
