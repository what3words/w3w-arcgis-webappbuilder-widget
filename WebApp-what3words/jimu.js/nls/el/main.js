define({
  "common": {
    ...
    "asc": "Αύξουσα",
    "desc": "Φθίνουσα",
    "opensInNewWindow": "Άνοιγμα σε νέο παράθυρο"
  },
  "limitedUnsupportedBrowser": {
    "title": "Περιορισμένη υποστήριξη προγράμματος περιήγησης",
    "onlineContent1": "Χρησιμοποιείτε ένα πρόγραμμα περιήγησης που είναι υπό απόσυρση. Ορισμένα τμήματα της εφαρμογής αυτής ενδέχεται να μη λειτουργούν με τον ιδανικό τρόπο ή να μη λειτουργούν καθόλου στο εν λόγω πρόγραμμα περιήγησης. Η υποστήριξη για το συγκεκριμένο πρόγραμμα περιήγησης θα διακοπεί στο μέλλον.",
    "content2": "Χρησιμοποιήστε τις πιο πρόσφατες εκδόσεις του <chrome-link>Google Chrome</chrome-link>, του <firefox-link>Mozilla Firefox</firefox-link>, του <safari-link>Apple Safari</safari-link> ή του <edge-link>Microsoft Edge</edge-link>.",
    "onlineContent3": "Για περισσότερες πληροφορίες όσον αφορά την υποστήριξη προγραμμάτων περιήγησης, ανατρέξτε στην τεκμηρίωσή μας. Πείτε μας τα σχόλιά σας μέσω του <feedback-link>GeoNet, της κοινότητας της Esri</feedback-link>.",
    "enterpriseContent1": "Χρησιμοποιείτε κάποιο πρόγραμμα περιήγησης που δεν υποστηρίζεται πλέον. Ορισμένα τμήματα της εφαρμογής αυτής ενδέχεται να μη λειτουργούν με τον ιδανικό τρόπο ή να μη λειτουργούν καθόλου στο εν λόγω πρόγραμμα περιήγησης."
  },
  "errorCode": "Κωδικός",
  "errorMessage": "Μήνυμα",
  ...
  "skips": {
    ...
    "tabAway": "Πατήστε Tab για να συνεχίσετε και να μετακινηθείτε έξω από την εφαρμογή, πατήστε Shift και Tab για να επιστρέψετε μέσα στο ${value} ."
  },
  "panelHeader": {
  ...
  "coordinateControl": {
    ...
    "significantDigitLabel": "Αριθμός Σημαντικών Ψηφίων:"
  },
  "richTextEditor": {
    "previewLinkToolTipsPrefix": "Σύνδεση με: ",
    "previewLinkToolTipsSuffix": "Η σύνδεση αυτή θα τίθεται σε λειτουργία κατά την εκκίνηση της εφαρμογής."
  },
  ...
  "blockedByAdminErrorForApp": "Ο οργανισμός σας έχει απαγορεύσει την πρόσβαση στην εφαρμογή αυτή. Για αναλυτικές πληροφορίες αποταθείτε στον διαχειριστή σας.",
  "blockedByAdminErrorForBuilder": "Ο οργανισμός σας έχει απαγορεύσει την πρόσβαση στο Web AppBuilder. Για αναλυτικές πληροφορίες αποταθείτε στον διαχειριστή σας.",
  "orgUrlMessage": "Η εφαρμογή στην οποία επιχειρείτε να αποκτήσετε πρόσβαση δεν προέρχεται από τη διεύθυνση URL που καταχωρήσατε.",
  "advancedOptions": "Σύνθετες επιλογές",
  "proceedTo": "Μετάβαση σε ${value}",
