...
define([
  ...
  return dojoDeclare([dijitWidgetBase, dijitTemplatedMixin, dijitWidgetsInTemplate], {
    ...
    templateString: '<div>' +
      ...
      '<div class = "esriCTSignificantDigitNode"><div class="formatText esriCTSignificantDigitLabel"' +
      'title ="${nls.significantDigitLabel}">${nls.significantDigitLabel}</div>' +
      '<div data-dojo-attach-point="significantDigitTextbox" value="2" data-dojo-type="dijit/form/NumberSpinner" ' +
      'data-dojo-props="constraints:{min:0,max:100,places:0}" aria-label="${nls.significantDigitLabel} style="width:50%"></div></div> ' +
