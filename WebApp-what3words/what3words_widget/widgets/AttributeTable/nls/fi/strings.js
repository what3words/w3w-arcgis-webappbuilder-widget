define({
  ...
  "rowHeaderColumnTitle": "Rivi ${rowId} korostettu. Valintakahva, valitse korostettu rivi painamalla Enter-näppäintä",
  "rowHeaderColumnTitleMultiple": "Rivi ${rowId}, ${rowCount} riviä korostettu. Valintakahva, valitse korostetut rivit painamalla Enter-näppäintä."
});